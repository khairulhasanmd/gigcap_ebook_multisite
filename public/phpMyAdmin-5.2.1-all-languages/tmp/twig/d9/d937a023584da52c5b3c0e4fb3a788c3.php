...
";
    ...
    {
        return new Source("", "console/toolbar.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/console/toolbar.twig");
    }
}
