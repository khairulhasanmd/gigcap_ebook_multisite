...
($context["position"] ?? null) == "right")) {
  ...
  ";
    ...
    {
        return new Source("", "display/results/checkbox_and_links.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/display/results/checkbox_and_links.twig");
    }
}
