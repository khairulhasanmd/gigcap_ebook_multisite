...
";
    ...
    {
        return new Source("", "database/structure/favorite_anchor.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/database/structure/favorite_anchor.twig");
    }
}
