...
";
    ...
    {
        return new Source("", "menu/breadcrumbs.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/menu/breadcrumbs.twig");
    }
}
