...
";
    ...
    {
        return new Source("", "recent_favorite_table_no_tables.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/recent_favorite_table_no_tables.twig");
    }
}
