...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/database/export/index.twig");
    }
}
