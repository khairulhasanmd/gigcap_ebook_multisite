...
echo _gettext("Go");
    ...
    {
        return new Source("", "table/insert/get_head_and_foot_of_insert_row_table.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/table/insert/get_head_and_foot_of_insert_row_table.twig");
    }
}
