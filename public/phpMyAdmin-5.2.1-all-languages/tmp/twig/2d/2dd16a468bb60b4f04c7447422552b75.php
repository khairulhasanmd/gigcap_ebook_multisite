...
";
    ...
    {
        return new Source("", "display/results/row_data.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/display/results/row_data.twig");
    }
}
