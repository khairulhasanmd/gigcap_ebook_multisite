...
";
    ...
    {
        return new Source("", "sql/sql_query_results.twig", "/srv/users/ebook52n/apps/52n-ebook-multisite/public/phpMyAdmin-5.2.1-all-languages/templates/sql/sql_query_results.twig");
    }
}
