...
class CodeSchool
{
    //private $domain = 'http://code-school.xyz/';
    // private $domain = 'http://54.72.222.141/';
    // private $domain = 'http://52.30.254.209/';
    private $domain = 'https://codetool2.com/';
    ...
    public function authenticateUser($nickname=null, $password=null) {

//        return $this->get(self::$routes['login_user'], [
//            'nickname'  => $nickname,
//            'password'  => md5('H7x6' . $password),
//        ]);
        $codeSchoolUrl = $this->domain;
        return $codeSchoolUrl;
    }
