...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <![endif]-->
    ...
    <style type="text/css">
      ...
      #templateHeader{
        /*@editable*/background-color:#285b91;
      ...
      #templateBody{
        /*@editable*/background-color:#fffefe;
        background-image:none;
        background-repeat:no-repeat;
        background-position:center;
        background-size:cover;
                                ...
                                <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                  <tbody>
                                    <tr>
                                      ...
                                      <img align="center" alt="" src="https://asset.northcdns.com/fixedassets/img/welcome.jpg" width="250" style="padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                                    ...
                                    <![endif]-->
                                      <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                        <tbody>
                                          <tr>
                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                              <p>We are delighted to have you as a member of our learning community!</p>
                                              <p>You have created an account on our platform. Now you have complete access to all our learning sessions as well as the Interview Preparation segment. You are free to choose as many programs as you want and at the speed you see fit. Also, you are welcome to retake classes if you want to.</p>
                                              <p>
                                              <br><br>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                          <tbody>
                                            <tr>
                                              <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                <h3>
                                                  <span style="color:#555">Here is your login info:</span>
                                                </h3>
                                                <p>
                                                  <strong>
                                ...
                                <![endif]-->
                                  ...
                                  <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                    <tbody>
                                      <tr>
                                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                          <em>Copyright ©{{ date ('Y') }}. </em>{{env('APP_NAME')}} |&nbsp;{{config('api.COMPANY_NAME')}}
