                    ...
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base"> <button type="button" class="btn btn btn-sm btn-light btn-flex  btn-active-light-primary" data-bs-toggle="modal" data-bs-target="#add_edit_modal">Add Concept</button> </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn btn-sm btn-light btn-flex  btn-active-light-primary" href="{{ route('concept.company.info', $row->id) }}">Get Company Info</a></td>
