                    ...
                    <div class="login-page__form-box">
                        <form method="POST" action="{{ route('saveChangePassword') }}" aria-label="{{ __('Change  Password') }}">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="password" class="form-control" id="email" name="password" placeholder="Type Here..."  autofocus required>
                              @if ($errors->has('email'))
                            ...
                            <div class="mb-3">
                              <label for="password" class="form-label">Repeat Your New Password</label>
                              <input type="password" class="form-control" id="password" name="password_confirmation" placeholder="Type Here..."  required>
                            ...
                            <div class="justify-content-between mt-5">
                              <input class="theme-btn px-1 me-2" type="submit" value="Change Password" >
