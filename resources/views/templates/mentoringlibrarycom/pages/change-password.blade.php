  ...
  <div class="breadcrumb-wrapper">
    ...
    <div class="container">
        <div class="page-heading">
            <h1>@lang('Change Your Password')</h1>
                ...
                <div class="login-page__left">
                    ...
                    <div class="login-page__form-box">
                        <form method="POST" action="{{ route('saveChangePassword') }}" aria-label="{{ __('Change  Password') }}">
                            @csrf                          
                            <div class="mb-3">
                              <label for="email" class="form-label">@lang('Enter Your New Password')</label>
                              <input type="password" class="form-control" id="email" name="password" placeholder="@lang('Type Here...')"  autofocus required>
                              @if ($errors->has('email'))
                            ...
                            <div class="mb-3">
                              <label for="password" class="form-label">@lang('Repeat Your New Password')</label>
                              <input type="password" class="form-control" id="password" name="password_confirmation" placeholder="@lang('Type Here...')"  required>
                            ...
                            <div class="justify-content-between mt-5">
                              <input class="theme-btn px-1 me-2" type="submit" value="@lang('Change Password')" >
