  ...
  <div class="breadcrumb-wrapper">
    ...
    <div class="container">
        <div class="page-heading">
            <h1>@lang('Cancel Subscription')</h1>
                    ...
                    <div class="login-page__form-box">
                        <form method="POST" action="{{ route('unsubscribeMembership') }}" class="row conact-form">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="email" class="form-control" id="email" name="email" placeholder="@lang('Email')*"autofocus required>
                              @if ($errors->has('email'))
                            ...
                            <div class="justify-content-between mt-5">
                              <input class="theme-btn px-1 me-2" type="submit" value="@lang('Unsubscribe')" >
