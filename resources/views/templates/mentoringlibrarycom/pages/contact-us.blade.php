    ...
    <div class="row">
        <div class="col-12">
            <div class="section__title-wrapper text-center mb-30">
                ...
                <h2 class="section__title-wrapper-title wow fadeInLeft animated" data-wow-delay=".3s">Connect with Us for <br> Expert Book Buying Advice and Assistance </h2>
            </div>
        </div>
    </div>
            ...
            <div class="media-content has--line wow fadeInLeft animated py-5" data-wow-delay=".2s">
                ...
                <div class="latest-contact-us-2-media-content-contact d-flex">
                    ...
                    <div class="latest-contact-us-2-media-content-contact-text">
                        <span>Call:</span>
                        <a href="tel:{{ config('booksee365com.SUPPORT_PHONE') }}">
                            <h6>{{ config('booksee365com.SUPPORT_PHONE') }}</h6>
                        </a>
                    </div>
                </div>
                <div class="latest-contact-us-2-media-content-contact d-flex align-item-center">
                    ...
                    <div class="latest-contact-us-2-media-content-contact-text">
                        <span>E-mail</span>
                        <a href="mailto:{{ config('booksee365com.SUPPORT_EMAIL') }}">
                            <h6>{{ config('booksee365com.SUPPORT_EMAIL') }}</h6>
                        </a>
                    </div>
                </div>
                <div class="latest-contact-us-2-media-content-contact d-flex">
                    ...
                    <div class="latest-contact-us-2-media-content-contact-text">
                        ...
                        <a href="https://maps.app.goo.gl/R8Y6ZY6s1KrcGWc67">
                            <h6>{{ config('booksee365com.COMPANY_NAME') }}, {{ config('booksee365com.COMPANY_ADDRESS') }}, <br> {{ config('booksee365com.COMPANY_CITY') }}, {{ config('booksee365com.COMPANY_POSTCODE')}} {{ config('booksee365com.COMPANY_COUNTRY') }}</h6>
                        </a>
                    </div>
                </div>
                <div class="latest-contact-us-2-media-content-contact d-flex">
                    ...
                    <div class="latest-contact-us-2-media-content-contact-text">
                        <span>Time</span>
                        <a href="https://maps.app.goo.gl/R8Y6ZY6s1KrcGWc67">
                            <h6>{{ config('booksee365com.SUPPORT_HOURS') }}</h6>
                        </a>
                    </div>
                </div>
            </div>
