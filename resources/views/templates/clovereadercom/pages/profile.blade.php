                                    ...
                                    <tbody>
                                        @foreach($orders->data as $order)
                                            <tr class="border-bm">
                                                ...
                                                <td><a href="{{\Illuminate\Support\Facades\URL::to('/get-order/'.$order->id)}}" class="custom-btn text-dark smoothscroll"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-receipt me-2" viewBox="0 0 16 16">
                                                  ...
                                                  </svg>@lang('trans_clovereadercom.Get Invoice')</a>
                                                </td>
                                            </tr>
                                        @endforeach
