        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 order-2 px-5 my-auto">
                <div class="login-page__left">
                    ...
                    <h3 class="login-page__title text-white">Sign Into Your Account</h3>
                            ...
                            <div class="mb-3 form-check">
                              <div class="row">
                                ...
                                <div class="col-6 text-end">
                                  <a href="{{route('welcome')}}#pricing-section" class="text-decoration-none">Don't have an account?</a>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row g-3">
                              <div class="col-6">
                                <div class="btn_wrapper">
                                  <button type="submit" class="wc-btn-pink btn-hover btn-item"><span></span> Login <i class="fa-solid fa-arrow-right"></i></button>
                                </div>
                              </div>
                              <div class="col-6">
                                  <div class="btn_wrapper">
