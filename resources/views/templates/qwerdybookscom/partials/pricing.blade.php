              ...
              <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="sec-title-wrapper">
                    <h2 class="sec-sub-title title-anim">@lang('Pricing Table')</h2>
                    <h3 class="sec-title title-anim">@lang('Nurture your mind with kindness')</h3>
                    <p>@lang('Be kind to your mind by prioritizing self-care, practicing mindfulness, and embracing positive thoughts. Take breaks, manage stress effectively, and allow yourself the time to rest and recharge for better mental health.')</p>
                  </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                ...
                @foreach($prices as $products)
                    ...
                    <div class="price__table">
                      <div class="price__item ">
                        ...
                        <div class="price__info">
                          ...
                          <h3 class="price__title">{{ $products->pricing_plan->subscription_interval_days }} @lang('days for') <div class="main-price"> {{ $products->pricing_plan->currency }}  {{ $products->pricing_plan->subscription_price }} </div></h3>
                          <p>
                            {{-- @if (app()->getLocale() === 'fr')
                            ...
                            @else
                              {{ $products->pricing_plan->subscription_trial_days }}-@lang('day trial period') / 
                        ...
                        <div class="price__amount">
                          @if( $products->pricing_plan->subscription_interval_days > 14)
                            <h4 class="best-value">@lang('Best Value')</h4>
                          @endif                          
                      ...
                      <div class="price__item animation_from_top">
                        <div class="price__info">
                          <h5 class="pb-2">@lang('This package features:')</h5>
                    ...
                    <div class="price__btn btn_wrapper">
                      <a href="{{ $products->purchase_url }}" class="wc-btn-black btn-hover btn-item"><span></span> @lang('Buy') <br> @lang('Now') <i
