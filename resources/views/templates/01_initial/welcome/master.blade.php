...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        @include('templates.01_initial.member.layouts.meta')
        @include('templates.01_initial.member.layouts.favicon')
        @include('templates.01_initial.welcome.styles')
        @include('templates.01_initial.member.layouts.head-scripts')
    </head>

    <body>
        @yield('main')

        @include('templates.01_initial.welcome.scripts')
