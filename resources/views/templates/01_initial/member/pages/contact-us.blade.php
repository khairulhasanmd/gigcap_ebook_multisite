                            ...
                            <div class="contact-info mb-4 mb-lg-0">
                                ...
                                <div class="location common mb-5 d-flex justify-content-start">
                                    <div class="c-img pe-2">
                                        ...
                                        <i class='fas fa-building fa-3x' style='color: #4CB47E; font-weight:100;'></i>
                                    </div>
                                ...
                                <div class="phone common mb-5 d-flex justify-content-start">
                                    <div class="c-img pe-2">
                                        ...
                                        <i class='fas fa-mobile fa-3x' style='color: #4CB47E;'></i>
                                    </div>
                                    <div class="c-des ps-2">
                                ...
                                <div class="website common mb-5 d-flex justify-content-start">
                                    <div class="c-img pe-2">
                                        ...
                                        <i class='fas fa-envelope fa-3x' style='color: #4CB47E; font-weight:100;'></i>
                                    </div>
                                    <div class="c-des ps-2">
                                        <h5>Visit website</h5>
                                ...
                                <div class="website common mb-5 d-flex justify-content-start">
                                    <div class="c-img pe-2">
                                        <!-- <img src="{{ asset('theme/images/contact/website.png') }}" alt="website"> -->
                                        <i class='fas fa-clock fa-3x' style='color: #4CB47E;font-weight:100;'></i>
                                    </div>
                                    <div class="c-des ps-2">
                                        <h5>Office Hours</h5>
                                        <p>09:00 - 16:00</p>
                            ...
                            <div class="contact-form">
                                <form action="{{ route('contact-us') }}" method="post">
                                    ...
                                    <div class="message mb-4">
                                        ...
                                        <textarea id="message" cols="30" rows="7" name="body" aria-invalid="false"></textarea>
                                    </div>
                                    <div class="send mb-4">
